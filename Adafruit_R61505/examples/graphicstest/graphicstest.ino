...
Adafruit_R61505 tft(SCREEN_WIDTH, SCREEN_HEIGHT,
  &SPI, OLED_DC, OLED_RESET, OLED_CS);

void setup() {
  Serial.begin(115200);
  Serial.println("R61505 Test!"); 
 ...
 // setRX(pin_size_t pin);  // assign RP2040 SPI0 pins
  ...
  SPI.setTX(7);
#else
  SPI.begin();  // not sure why this is needed for AVR - something not quite right in the driver
#endif
